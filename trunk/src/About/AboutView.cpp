...
AboutView::AboutView(BRect frame):BView(frame, "", B_FOLLOW_ALL, B_WILL_DRAW)
{
	...
	fMailView = new URLView( BRect(fContactTitleString.Length()+90+150, frameHeight-62, frameWidth-5, frameHeight-47), "E-mail", "send me a E-mail", "mail@projectconceptor.de");
