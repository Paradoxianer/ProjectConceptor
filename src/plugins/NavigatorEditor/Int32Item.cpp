...
Int32Item::Int32Item(char *newLabel,
		int32 newValue,
		uint32 level,
		bool expanded)
...
{
	svalue			= new char[24];
	sprintf(svalue,"%ld",(long)newValue);
...
void Int32Item::Update(BView *newOwner, const BFont *font)
{
...
void Int32Item::DrawItem(BView *owner, BRect bounds, bool complete)
{
...
void Int32Item::Select(void)
{
}
void Int32Item::Deselect(void)
{
}

void Int32Item::SetExpanded(bool /*expande*/)
{
};

status_t Int32Item::Invoke(BMessage *message)
{
	...
	if (sendMessage != NULL)
	{
		...
		valueContainer->AddInt32("newValue", GetInt32());
