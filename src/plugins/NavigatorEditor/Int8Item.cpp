...
Int8Item::Int8Item(char *newLabel,
		int8 newValue,
		uint32 level,
		bool expanded)
	: BaseListItem(B_INT8_TYPE, level, expanded)
{
	svalue			= new char[24];
...
void Int8Item::Update(BView *newOwner, const BFont *font)
{
...
void Int8Item::DrawItem(BView *owner, BRect bounds, bool complete)
{
...
void Int8Item::Select(void)
{
}
void Int8Item::Deselect(void)
{
}

void Int8Item::SetExpanded(bool /*expande*/)
{
};

status_t Int8Item::Invoke(BMessage *message)
{
	...
	if (sendMessage != NULL)
	{
		...
		valueContainer->AddInt8("newValue", GetValue());
