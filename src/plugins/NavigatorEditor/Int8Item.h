...
class Int8Item : public BaseListItem
{
public:
						Int8Item(char *newLabel,int8 newValue, uint32 level = 0, bool expanded = true);
	virtual	int8		GetValue(void){return (int8)atoll(value->Text());};
