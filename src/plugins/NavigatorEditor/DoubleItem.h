#ifndef DOUBLE_ITEM_H
#define DOUBLE_ITEM_H
/*
...
class DoubleItem : public BaseListItem
{
public:
						DoubleItem(char *newLabel,double newValue, uint32 level = 0, bool expanded = true);
	virtual	double		GetDouble(void){return atof(value->Text());};
